...
struct ContentView: View {
    ...
    let tipCalculate = TipCalculator()
    var body: some View {
        NavigationView {
            ...
            VStack {
                ...
                Picker(selection: $tipPercentage) {
                    ...
                    .accessibilityIdentifier("tipPercentageSegmentedController")
                ...
                Button() {
                    ...
                    guard let total = Double(self.total) else {
                        ...
                        return }
                    do {
                      let result =  try tipCalculate.calculate(total: total, tipPercentae: tipPercentage)
                        let formatter = NumberFormatter()
                        formatter.numberStyle = .currency
                        tip = formatter.string(from: NSNumber(value: result))
                    } catch TipCalculateError.invalidInput {
                        message = "Invalid Input"
                    }catch {
